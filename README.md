...
![](results/coupling_comparison.png)

![](results/future_discovery.png)
...
![](results/lhc_discovery_potential.png)

- ![](results/scalar_predictions.png)

![](results/updated_discovery_timeline.png)
